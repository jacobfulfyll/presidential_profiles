...
.issue-local-nav{contain:inline-size}.issue-local-nav ul{display:flex;max-width:100%;gap:4px;overflow-x:auto;margin:0;padding:5px;border:1px solid
  ...
  color:var(--ink)}.issue-nav-cue{display:none;color:var(--muted);font-size:12px;font-weight:740;
  white-space:nowrap}.issues-page main{padding-top:1px}.issues-page main>section{scroll-margin-top:
...
@media(max-width:760px){.issue-facts{grid-template-columns:1fr}.issue-local-nav{margin-top:11px;
  padding:0 8px}.issue-nav-cue{display:inline-flex;min-height:24px;align-items:center;padding-inline:7px}
  .issue-local-nav ul{padding:3px;scrollbar-gutter:stable}.issue-local-nav a{min-height:44px;font-size:14px}
  .issue-fact span,.excerpt-label,.receipt,.fine-definition span,.fine-selects label,
  .issue-adjacent span,.directory-card dt{font-size:12px!important}
  ...
  .topic-controls label,.topic-picker summary,.exact-values summary,.download-links a{min-height:44px}
  .provenance-grid{grid-template-columns:1fr}.chart-scroll{
